import FooterCard from "@/components/pages/home/footer-card";
    ...
    <main className="space-y-40">
      ...
      >
        <div className="space-y-7">
          <h3 className=" text-6xl">
            ...
            <span className="bg-violet-200 px-2 rounded-xl">
              effortles
            </span>{" "}
      ...
      <footer className="flex justify-between bg-zinc-300">
        <div className=" border-2 flex justify-center items-center bg-white rounded-lg w-64">
          <Button className="rounded-full uppercase px-5">Get Started</Button>
        </div>
        <FooterCard
