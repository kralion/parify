        ...
        <div className="flex gap-16 items-center ">
          <div className="flex gap-2">
            {navLinks.map((link) => {
              return (
                <NavLink
                  activeClassName="bg-slate-900 text-slate-50 rounded-full w-32 dark:bg-slate-50 dark:text-slate-300 dark:text-black flex py-2 items-center justify-center pr-2 "
